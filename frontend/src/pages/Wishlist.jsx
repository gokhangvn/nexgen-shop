    ...
    <div className="container mx-auto px-6 py-20 min-h-screen">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 mb-20">
        ...
        <div className="glass px-10 py-5 rounded-full border border-primary/20 flex items-center gap-4">
          ...
          <span className="text-2xl font-black italic tracking-tighter">{wishlist.length} ÜRÜN</span>
        </div>
      </div>
                ...
                <div className="px-2 space-y-4">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 bg-primary text-white py-4 rounded-2xl font-black text-xs hover:shadow-lg hover:shadow-primary/30 transition-all"
                    >
                      SEPETE EKLE
                    </button>
                    <Link to={`/product/${product.id}`} className="bg-muted p-4 rounded-2xl hover:bg-white transition-colors">
                      <ArrowRight size={18} />
                    </Link>
                  </div>
                </div>
